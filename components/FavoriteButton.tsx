...
interface FavoriteButtonProps {
    ...
    const toggleFavorites = useCallback(async () => {
        ...
        if (isFavorite) {
        response = await axios.delete('/api/favorite', { data: { courseId } });
        } else {
        response = await axios.post('/api/favorite', { courseId });
        }
        ...
        mutateFavorites();
    }, [courseId, isFavorite, currentUser, mutate, mutateFavorites]);
